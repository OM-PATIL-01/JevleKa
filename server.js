...
try {
    ...
    console.warn("Make sure serviceAccountKey.json exists in your project folder.");
}
...
app.post('/api/auth/google', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        if (rows.length === 0) {
            ...
            // For Google users, we set a dummy password or null if schema allows (here it's TEXT)
